...
Public Class ReportePago___Copia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegistroHorasExtra.ReportePago - Copia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportePago___Copia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportePago___Copia = New ReportePago___Copia()
        rpt.Site = Me.Site
        Return rpt
    End Function
